...
if (!Array.isArray(labels.items) || labels.items.length !== 69_000) throw new Error(`R14 requires exactly 69,000 catalog records, found ${labels.items?.length}`);
...
if (renderAudit.visualDuplicatesSuppressed !== 0) throw new Error('R14 must not suppress source records');
